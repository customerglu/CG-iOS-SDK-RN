...
public class CGNudgeConfiguration:NSObject {
    ...
    public init(closeOnDeepLink : Bool = CustomerGlu.auto_close_webview!, opacity : Double = 0.5, layout : String = "",url : String = "", absoluteHeight : Double = 0.0, relativeHeight : Double = 0.0, width : Double = 0.0) {
